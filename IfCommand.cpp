            ...
            if (arg1 < arg2) {
                ...
                for (j = 0; j < k; j++) {
                    ...
                    if (CommandsMap::getInstanceCommandMap()->getCommandMap().find(token)
                        ...
                        i += CommandsMap::getInstanceCommandMap()->getCommandMap().at(token)->execute(i, lexerData);
                    }
                }
            }
            break;
