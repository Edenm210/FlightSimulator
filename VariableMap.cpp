...
vector<string> VariableMap::VarGenNamesVec = {};
...
void VariableMap::print() {
    int i;
    string str;
    for (i = 0; i < VariableMap::VarGenNamesVec
    .size(); i++) {
        str = VariableMap::VarGenNamesVec
        .at(i);
