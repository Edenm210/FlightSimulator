...
VariableMap::~VariableMap() { this->varsMap.clear(); }
...
void VariableMap::setVarValue(string name, float newValue){
  VariableMap::getInstanceVarsMap()->getVarsMap().find(name)->second->changeVarValue(newValue);
}
...
unordered_map<string, Var*> VariableMap::getVarsMap() {
  return this->varsMap;
}
...
//  v1->val = 0;
//  v1->direct = "";
  this->VarNames.emplace_back("airspeed-indicator_indicated-speed-kt");
  this->varsMap[simVar] = v1;
...
//  v2->val = 0;
//  v2->direct = "";
//  this->VarNames.emplace_back("time_warp");
//  this->varsMap[varName] = v2;
//
...
//  v3->val = 0;
//  v3->direct = "";
//  this->VarNames.emplace_back("switches_magnetos");
//  this->varsMap[varName] = v3;
//
...
//  v4->val = 0;
//  v4->direct = "";
//  this->VarNames.emplace_back("heading-indicator_offset-deg");
//  this->varsMap[varName] = v4;
//
...
//  v5->val = 0;
//  v5->direct = "";
//  this->VarNames.emplace_back("altimeter_indicated-altitude-ft");
//  this->varsMap[varName] = v5;
//
...
//  v6->val = 0;
//  v6->direct = "";
//  this->VarNames.emplace_back("altimeter_pressure-alt-ft");
//  this->varsMap[varName] = v6;
//
...
//  v7->val = 0;
//  v7->direct = "";
//  this->VarNames.emplace_back("attitude-indicator_indicated-pitch-deg");
//  this->varsMap[varName] = v7;
//
...
//  v8->val = 0;
//  v8->direct = "";
//  this->VarNames.emplace_back("attitude-indicator_indicated-roll-deg");
//  this->varsMap[varName] = v8;
//
...
//  v9->val = 0;
//  v9->direct = "";
//  this->VarNames.emplace_back("attitude-indicator_internal-pitch-deg");
//  this->varsMap[varName] = v9;
//
...
//  v10->val = 0;
//  v10->direct = "";
//  this->VarNames.emplace_back("attitude-indicator_internal-roll-deg");
//  this->varsMap[varName] = v10;
//
...
//  v11->val = 0;
//  v11->direct = "";
//  this->VarNames.emplace_back("encoder_indicated-altitude-ft");
//  this->varsMap[varName] = v11;
//
...
//  v12->val = 0;
//  v12->direct = "";
//  this->VarNames.emplace_back("encoder_pressure-alt-ft");
//  this->varsMap[varName] = v12;
//
...
//  v13->val = 0;
//  v13->direct = "";
//  this->VarNames.emplace_back("gps_indicated-altitude-ft");
//  this->varsMap[varName] = v13;
//
...
//  v14->val = 0;
//  v14->direct = "";
//  this->VarNames.emplace_back("gps_indicated-ground-speed-kt");
//  this->varsMap[varName] = v14;
//
...
//  v15->val = 0;
//  v15->direct = "";
//  this->VarNames.emplace_back("gps_indicated-vertical-speed");
//  this->varsMap[varName] = v15;
//
...
//  v16->val = 0;
//  v16->direct = "";
//  this->VarNames.emplace_back("indicated-heading-deg");
//  this->varsMap[varName] = v16;
//
...
//  v17->val = 0;
//  v17->direct = "";
//  this->VarNames.emplace_back("magnetic-compass_indicated-heading-deg");
//  this->varsMap[varName] = v17;
//
...
//  v18->val = 0;
//  v18->direct = "";
//  this->VarNames.emplace_back("lip-skid-ball_indicated-slip-skid");
//  this->varsMap[varName] = v18;
//
...
//  v19->val = 0;
//  v19->direct = "";
//  this->VarNames.emplace_back("turn-indicator_indicated-turn-rate");
//  this->varsMap[varName] = v19;
//
...
//  v20->val = 0;
//  v20->direct = "";
//  this->VarNames.emplace_back("vertical-speed-indicator_indicated-speed-fpm");
//  this->varsMap[varName] = v20;
//
...
//  v21->val = 0;
//  v21->direct = "";
//  this->VarNames.emplace_back("flight_aileron");
//  this->varsMap[varName] = v21;
//
...
//  v22->val = 0;
//  v22->direct = "";
//  this->VarNames.emplace_back("flight_elevator");
//  this->varsMap[varName] = v22;
//
...
//  v23->val = 0;
//  v23->direct = "";
//  this->VarNames.emplace_back("flight_rudder");
//  this->varsMap[varName] = v23;
//
...
//  v24->val = 0;
//  v24->direct = "";
//  this->VarNames.emplace_back("flight_flaps");
//  this->varsMap[varName] = v24;
//
...
//  v25->val = 0;
//  v25->direct = "";
  this->VarNames.emplace_back("engine_throttle");
  this->varsMap[simVar] = v25;
//
...
//  v26->val = 0;
//  v26->direct = "";
  this->VarNames.emplace_back("current-engine_throttle");
  this->varsMap[simVar] = v26;
//
...
//  v27->val = 0;
//  v27->direct = "";
//  this->VarNames.emplace_back("switches_master-avionics");
//  this->varsMap[varName] = v27;
//
...
//  v28->val = 0;
//  v28->direct = "";
//  this->VarNames.emplace_back("switches_starter");
//  this->varsMap[varName] = v28;
//
...
//  v29->val = 0;
//  v29->direct = "";
//  this->VarNames.emplace_back("active-engine_auto-start");
//  this->varsMap[varName] = v29;
//
...
//  v30->val = 0;
//  v30->direct = "";
//  this->VarNames.emplace_back("flight_speedbrake");
//  this->varsMap[varName] = v30;
//
...
//  v31->val = 0;
//  v31->direct = "";
//  this->VarNames.emplace_back("c172p_brake-parking");
//  this->varsMap[varName] = v31;
//
...
//  v32->val = 0;
//  v32->direct = "";
//  this->VarNames.emplace_back("engine_primer");
//  this->varsMap[varName] = v32;
//
...
//  v33->val = 0;
//  v33->direct = "";
//  this->VarNames.emplace_back("current-engine_mixture");
//  this->varsMap[varName] = v33;
//
//  std::cout << varsMap.find("flight_flaps")->second->val << std::endl;
//
//  v24->val = 8;
//  std::cout << varsMap.find("flight_flaps")->second->val << std::endl;
